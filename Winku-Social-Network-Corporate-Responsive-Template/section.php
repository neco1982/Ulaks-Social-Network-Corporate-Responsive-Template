...
if(isset($_POST['Mesaj'])){
    ...
    //$mesaj='section.php?Mesaj='.$_GET['Mesaj'];
    //header('location:'.$mesaj);
$curl_handle=curl_init();
curl_setopt($curl_handle, CURLOPT_URL,'https://api-pay-sys.herokuapp.com/?user_id=33&text_content='.$mesaj.'&visual_content_url=-');
