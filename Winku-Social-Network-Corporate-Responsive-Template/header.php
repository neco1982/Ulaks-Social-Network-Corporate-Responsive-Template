<?php 
$member=file_get_contents("https://api-pay-sys.herokuapp.com/?uid=wVYBgLJ5GUOMbvVP4uQZbODs5MS2");
...
<div class="theme-layout">
	...
	<div class="topbar stick">
		...
		<div class="top-area">
			...
			<div class="user-img">							
				<img src="<?php echo $photo_url; ?>" width="63" height="auto" alt="">				
			...
			<input type="button" style="font-size:10px;" value="<?php echo $name; echo $uid; ?>">
